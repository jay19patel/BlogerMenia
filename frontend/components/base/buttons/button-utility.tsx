...
export const styles = {
    secondary:
        "bg-primary text-fg-quaternary shadow-xs-skeuomorphic border border-slate-300 hover:border-slate-400 hover:bg-primary_hover hover:text-secondary_hover disabled:shadow-xs",
