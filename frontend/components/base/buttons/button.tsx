...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-primary text-secondary shadow-xs-skeuomorphic border border-slate-300 hover:border-slate-400 hover:bg-primary_hover hover:text-secondary_hover data-loading:bg-primary_hover",
                // Icon styles
