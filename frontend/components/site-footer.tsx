      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-14">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <Link href={urls.home()} className="flex items-center gap-2.5 group">
            ...
            <span className="font-extrabold text-slate-900 tracking-tight text-xl group-hover:text-brand-600 transition-colors">
          ...
          <div className="flex items-center gap-6">
            <Link href={urls.contact()} className="text-sm font-semibold text-slate-500 hover:text-brand-600 transition-colors">
              Contact Us
            </Link>
