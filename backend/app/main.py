...
from app.api.routers import blogs as blog_router
from app.api.routers import media as media_router
from app.api.routers import playlists as playlists_router
...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        description="AI blog generation (Gemini + LangGraph) + full blog CRUD with MongoDB and Redis",
        version="3.0.0",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
